...
plt.title('Accuracy')
plt.savefig('cm_overfittingCheck.png',dpi=300,format='png')
plt.close()
print('Result saved into 05_overfittingCheck.png')

plt.figure(1)
plt.plot(range(len(pred_y)), pred_y,label='credit dist')
plt.savefig('pred-credit.png',dpi=150,format='png')
plt.close()
print('Result saved into 05_overfittingCheck.png')
